                                ...
                                <div class="card-body">
                                    <div class="media d-flex">
                                        ...
                                        <div class="media-body text-right">
                                            <h5 class="text-muted text-bold-500">Menu</h5>
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body text-left">
                                        <h5 class="text-muted text-bold-500">Selamat Datang di Sistem Aplikasi Penjualan
                           CAFE_KITA, <b class='text-danger'><?php echo $nama; ?></b> </h5>
