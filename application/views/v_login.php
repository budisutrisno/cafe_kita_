...
<body class="vertical-layout vertical-menu 1-column  bg-full-screen-image" data-open="click"
                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                <div class="card-header border-0">
                                    <div class="card-title text-center">
                                        <img src="<?= base_url() ?>app-assets/images/logo/kopi.png"
                                            alt="branding logo">
                                    </div>
                                    <h6 class="card-subtitle line-on-side text-danger text-center font-small-2 pt-12">
                                        <span><B>SELAMAT DATANG SISTEM APLIKASI PENJUALAN CAFE_KITA</B></span></h6>
                                </div>
