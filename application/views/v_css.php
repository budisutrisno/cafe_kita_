<head>
    ...
    <link rel="apple-touch-icon" href="<?= base_url() ?>app-assets/images/logo/kopi.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url() ?>app-assets/images/logo/kopi.png">
    <link
